...
> Status: **0.8.0 released.** CLI, core rite, batches, lifecycle, migration, per-cycle tickets, local
> cycles, workspaces, section titles in any language and an inline triage that never marks stale by mistake. See [CHANGELOG.md](CHANGELOG.md) and the [Roadmap](#roadmap).
