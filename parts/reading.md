...
pitfalls entries matching its files, type and phase. Read that instead of opening those files.
...
- Item and source of truth disagree → the source wins, and the disagreement goes in the report.
